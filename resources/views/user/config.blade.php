    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('user.update')}}" enctype="multipart/form-data"> <!-- primordial para subir archivos enctype="multipart/form-data" -->
                        @csrf
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                @include('include.avatar') <!--Incluede del avatar-->
